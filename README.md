...
│   ├── server.py                        # Python 통합 서버 (REST API + 정적 파일 서빙)
...
│   │   └── index.html                   # 메인 뷰 마크업 (5대 핵심 뷰 통합)
│   ├── css/                             # 🎨 [CSS] 스타일시트 계층
...
├── log.md                               # 구조 개편 및 이슈 해결 로그
├── requirements.txt                     # Python 의존성 패키지 명세
└── index.html                           # 루트 엔트리포인트 (정적 웹 호환용)
```
